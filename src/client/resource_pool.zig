...
test "ResourceManager" {
...

    {
        ...
        var font_id = try manager.getName("/assets/font.tex");
        var potato_id = try manager.getName("/assets/potato.tex");
        var floor_id = try manager.getName("/assets/bad_floor.tex");
